                  ...
                  <span className="text-xs text-gray-300 w-8">{eqHigh}%</span>
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-3">
                        {fxList.map(function(fx) {
                          return (
                            <button
                              key={fx}
                              onClick={function() { setActiveFx(activeFx === fx ? "" : fx); }}
                      ...
                      {activeFx && (
                        <div className="space-y-2">
                          <div className="flex items-center gap-3">
                            ...
                            <input type="range" min={0} max={100} value={fxWet} onChange={function(e) { setFxWet(Number(e.target.value)); }} className="flex-1 accent-purple-500" />
                    ...
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          ...
                          <input type="range" min={0} max={100} value={masterGain} onChange={function(e) { setMasterGain(Number(e.target.value)); }} className="flex-1 accent-green-500" />
                          <span className="text-xs text-gray-300 w-8">{masterGain}%</span>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="text-xs text-blue-400 w-16">X-Fader</span>
                          <span className="text-xs text-gray-500">A</span>
                          <input type="range" min={0} max={100} value={crossfader} onChange={function(e) { setCrossfader(Number(e.target.value)); }} className="flex-1 accent-blue-500" />
                          <span className="text-xs text-gray-500">B</span>
                          <span className="text-xs text-gray-300 w-8">{crossfader}%</span>
                        </div>
                        <div className="flex items-center gap-3">
                          <span className="text-xs text-yellow-400 w-16">Pitch</span>
                          <input type="range" min={-12} max={12} value={pitchShift} onChange={function(e) { setPitchShift(Number(e.target.value)); }} className="flex-1 accent-yellow-500" />
                    ...
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button onClick={function() { setShowPlaylistPanel(!showPlaylistPanel); }} className="text-xs text-gray-400 hover:text-white px-2 py-1 rounded bg-gray-700">
                      ...
                      {showPlaylistPanel && (
                        <div className="space-y-2">
                          <div className="flex gap-2">
                            <input type="text" value={newPlaylistName} onChange={function(e) { setNewPlaylistName(e.target.value); }} placeholder="New playlist..." className="flex-1 bg-gray-700 text-white text-xs rounded px-2 py-1 border border-gray-600" />
                          ...
                          {Object.keys(playlists).length > 0 ? (
                            <div className="space-y-1">
                              {Object.keys(playlists).map(function(name) {
                                return (
                                  <div key={name} className={currentPlaylist === name ? "flex items-center justify-between px-2 py-1 rounded bg-orange-900 border border-orange-700" : "flex items-center justify-between px-2 py-1 rounded bg-gray-700 hover:bg-gray-600 cursor-pointer"} onClick={function() { setCurrentPlaylist(name); }}>
                    ...
                    <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <button onClick={function() { setShowHistory(!showHistory); }} className="text-xs text-gray-400 hover:text-white px-2 py-1 rounded bg-gray-700">
                          {showHistory ? "Hide" : "Show"}
                        </button>
                      </div>
                      {showHistory && (
                        <div className="space-y-1 max-h-48 overflow-y-auto">
                          {djHistory.length > 0 ? djHistory.map(function(entry, i) {
                            return (
