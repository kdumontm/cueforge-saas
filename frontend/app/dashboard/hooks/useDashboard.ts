...
import {
  Upload, Music2, Loader2, CheckCircle2, XCircle, Download, Clock,
  Activity, Hash, ChevronDown, ChevronUp, ExternalLink, User, Tag,
  Calendar, AlbumIcon, Play, Pause, SkipBack, SkipForward, Volume2, VolumeX,
  Search, MoreVertical, Wand2, Type, Disc, RefreshCw, Star, Filter,
  Grid3X3, List as ListIcon, Check, X, Music, Headphones, ArrowUpDown,
...
// ── Imports centralisés ──────────────────────────────────────────────────
import { toCamelot, isMixCompatible, msToTime, formatTime, generateCuePointsFromAnalysis, energyToRating, energyToLabel, energyToColor, keyCamelot, mixScore, filterBand, computeRGBWaveform } from './utils';
import { TR } from './translations';
import { WAVEFORM_THEMES, REKORDBOX_COLORS, CUE_TYPE_COLORS, CONTEXT_ACTIONS } from './constants';
