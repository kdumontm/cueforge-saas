...
.v4-auth .field-hint.ok { color: #86efac; }
.v4-auth .field-hint.warn { color: #fbbf24; }
.v4-auth .field-hint.err { color: #fca5a5; }
.v4-auth .alert {
  margin-bottom: 14px;
  padding: 12px 14px;
  border-radius: 12px;
    ...
    <>
      ...
      <div className="v4-auth">
        ...
        <div className="auth-card">
          ...
          <p className="auth-sub">Gratuit. 30 secondes. Pas de carte bancaire.</p>

          <div className="trust-row">
            <span className="trust"><span className="tick">✓</span> BPM auto</span>
            <span className="trust"><span className="tick">✓</span> Cue points</span>
            <span className="trust"><span className="tick">✓</span> Export XML</span>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="field">
              <label htmlFor="username">
                Nom d&apos;utilisateur <span className="hint">(utilisé pour te connecter)</span>
              </label>
              <input
                id="username"
                type="text"
            ...
            <div className="field">
              <label htmlFor="email">
                Email <span className="hint">(pour récupérer ton compte)</span>
              </label>
              <input
                id="email"
                type="email"
            ...
            <div className="field">
              ...
              {password.length > 0 && (
                <div id="pwdStrengthHelp" className={`field-hint ${pwdStrong ? 'ok' : 'warn'}`}>
                  {pwdStrong ? '✓ Mot de passe valide' : '⚠ Trop court (min. 8 caractères)'}
                </div>
              )}
            </div>
            ...
            <div className="field">
              ...
              />
              {confirm.length > 0 && (
                <div id="pwdMatchHelp" className={`field-hint ${pwdMatch ? 'ok' : 'err'}`}>
            ...
            >
              {loading ? (
                <><span className="spinner-inline" />Création…</>
              ) : 'Créer mon compte'}
            </button>
          </form>
