...
_FALLBACK = {
    "version": "3.3.0",
    "release_notes": "CueForge Desktop v3.3.0 — Migration vers coquille web + bridge local",
    "dmg_arm64_url": f"https://github.com/{GITHUB_REPO}/releases/download/v3.3.0/CueForge-3.3.0-arm64.dmg",
    "dmg_arm64_size": "~80 MB",
    "dmg_x64_url": f"https://github.com/{GITHUB_REPO}/releases/download/v3.3.0/CueForge-3.3.0-x64.dmg",
    "dmg_x64_size": "~80 MB",
    "exe_url": f"https://github.com/{GITHUB_REPO}/releases/download/v3.3.0/CueForge-3.3.0-x64.exe",
    "exe_size": "~65 MB",
}
